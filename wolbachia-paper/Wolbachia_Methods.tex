...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=85.0mm]{Fams_n_Props.pdf}
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=85.0mm]{infection_Prob.pdf}
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=180.0mm]{familyProb.pdf}
